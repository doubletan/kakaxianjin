            ...
            public void onDownloadStart(final String url, String userAgent, String contentDisposition, String mimetype,
                ...
                if (url.endsWith(".apk")) {//判断是否是.apk结尾的文件路径
                    if (DeviceUtil.isWifiAvailable(WebViewActivity.this)) {
                        ...
                        final AlertDialog alertDialog = new AlertDialog.Builder(WebViewActivity.this,R.style.CustomDialog).create();
        ...
        PopupWindowUtil.showPopupWindow(this,rootView,"相机","文件","取消",
                new PopupWindowUtil.onPupupWindowOnClickListener() {
                    ...
                    public void onFirstButtonClick() {
                        int flag1 = ActivityCompat.checkSelfPermission(WebViewActivity.this, Manifest.permission.CAMERA);
                        int flag2 = ActivityCompat.checkSelfPermission(WebViewActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE);
                        if (PackageManager.PERMISSION_GRANTED != flag1|| PackageManager.PERMISSION_GRANTED != flag2) {
                            ActivityCompat.requestPermissions(WebViewActivity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE}, Constants.REQUEST_CODE_CAMERA_PERMISSION);
                    ...
                    public void onSecondButtonClick() {
                        ...
                        if (PackageManager.PERMISSION_GRANTED != flag2) {
                            ActivityCompat.requestPermissions(WebViewActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, Constants.REQUEST_CODE_READ_EXTERNAL_PERMISSION);
                            cancelFilePathCallback();
                        }else {
                            takeForPhoto();
                        }
    ...
    private void takeForPicture() {
        ...
        try {
            ...
            if (storageState.equals(Environment.MEDIA_MOUNTED)) {
                ...
                Toast.makeText(WebViewActivity.this, "未挂载sdcard", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            if (Build.VERSION.SDK_INT > 23) {//7.0及以上
                origUri = FileProvider.getUriForFile(WebViewActivity.this, Constants.fileprovider, new File(vFile, fileName));
