...
public class MainCreditProductAdapter extends BaseAdapter<CreditProduct.CardListProduct>{
    private final Context context;
    private ArrayList<CreditProduct.CardListProduct> data;

    public MainCreditProductAdapter(Context context, ArrayList<CreditProduct.CardListProduct> data) {
        super(context, data);
        if (data == null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            // 加载模板得到View对象
            convertView = getLayoutInflater().inflate(R.layout.main_fragment_item, null);
            // 创建新的ViewHolder
            holder = new ViewHolder();
            // 从模板对象中获取控件
            holder.t1 = (TextView) convertView.findViewById(R.id.main_fragment_item_tv1);
            holder.t2 = (TextView) convertView.findViewById(R.id.main_fragment_item_tv2);
            holder.i1 = (ImageView) convertView.findViewById(R.id.main_fragment_item_iv);
        ...
        holder.t2.setText(cr.getJianjie());
